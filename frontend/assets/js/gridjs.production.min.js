!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).gridjs =
          {})
      );
})(this, function (t) {
  "use strict";
    ...
    for (n.__e = m, p = P; p--; )
      null != b[p] &&
        ("function" == typeof n.type &&
          ...
          (n.__d = S(r, p + 1)),
        U(b[p], b[p]));
    if (y) for (p = 0; p < y.length; p++) j(y[p], y[++p], y[++p]);
  }
  function E(t, e, n) {
    var r, o;
  ...
  function D(t, e, n, r, o) {
    ...
    t: if ("style" === e)
      ...
      (i = e !== (e = e.replace(/Capture$/, ""))),
        ...
        (t.l[e + i] = n),
        n
          ? r || t.addEventListener(e, i ? R : O, i)
          : t.removeEventListener(e, i ? R : O, i);
    ...
    try {
      t: if ("function" == typeof x) {
        ...
        (c.context = b),
          ...
          m && (c.__E = c.__ = null),
          (c.__e = !1);
      } else null == i && e.__v === n.__v ? ((e.__k = n.__k), (e.__e = n.__e)) : (e.__e = A(n.__e, e, n, r, o, i, s, l));
      (p = a.diffed) && p(e);
    } catch (t) {
      (e.__v = null),
        (l || null != i) &&
    ...
    if (null === g) h === _ || (a && t.data === _) || (t.data = _);
      ...
      a ||
        ("value" in _ &&
          ...
          D(t, "value", y, h.value, !1),
        "checked" in _ &&
          void 0 !== (y = _.checked) &&
          y !== t.checked &&
          D(t, "checked", y, h.checked, !1));
    }
    return t;
  }
  function j(t, e, n) {
  ...
  var z = {
    ...
    q = (function () {
      function t(t) {
        (this._language = t), (this._defaultLanguage = z);
      }
      return (
  ...
  function $(t, e) {
    return y(X, { content: t, parentElement: e });
  }
  var K = (function (t) {
      function e(e) {
          ...
          if (this.props.pluginId) {
            ...
            return e
              ? y(
                  w,
                  {},
                  y(e.component, r(r({ plugin: e }, e.props), this.props.props))
                )
              : null;
          }
  ...
  var vt = (function (t) {
    function e(e, n) {
      var r = t.call(this, e, n) || this,
        o = r.props.tableRef;
      return (
        (r.tableElement = o.current.base.cloneNode(!0)),
    ...
    return (
      n(e, t),
      (e.prototype.widths = function () {
        (this.tableElement.className =
          this.tableClassName + " " + et("shadowTable")),
  ...
  var wt,
    Pt = (function (e) {
      ...
      return (
        ...
        (o.prototype.adjustWidth = function (t) {
          var e = t.container,
            n = t.tableRef,
            r = t.tempRef,
            i = t.tempRef || !0;
          ...
          var s = e.clientWidth,
            ...
            u = {};
          if (n.current && i) {
            var l = y(vt, { tableRef: n });
            (l.ref = a), H(l, r.current), (u = a.current.widths());
          }
          for (
            var p = 0,
              c = o.tabularFormat(this.columns).reduce(function (t, e) {
                return t.concat(e);
              }, []);
            p < c.length;
            p++
            ...
            var h = c[p];
            (h.columns && h.columns.length > 0) ||
              (!h.width && i
                ? h.id in u &&
                  ((h.width = yt(u[h.id].width)),
                  (h.minWidth = yt(u[h.id].minWidth)))
                : (h.width = yt(mt(h.width, s))));
          }
          return n.current && i && H(null, r.current), this;
        }),
        ...
        (o.prototype.setResizable = function (t, e) {
          for (var n = 0, r = e || this.columns || []; n < r.length; n++) {
            var o = r[n];
            void 0 === o.resizable && (o.resizable = t.resizable),
    ...
    Rt = (function () {
      ...
      return (
        (t.createFromConfig = function (t) {
          var e = new Et();
          return (
            t.storage instanceof kt &&
              e.register(new Dt({ serverStorageOptions: t.server })),
            e.register(new Tt({ storage: t.storage })),
            e.register(new Ot({ header: t.header })),
            e.register(new Ft()),
            e
          );
        }),
      ...
      return (
        ...
        (e.fromUserConfig = function (n) {
          ...
          return (
            ...
            o.assign({ header: Pt.fromUserConfig(o) }),
            o.assign({ storage: Nt.createFromUserConfig(n) }),
            o.assign({ pipeline: Rt.createFromConfig(o) }),
            o.assign({ translator: new q(n.language) }),
            o.plugin.add({
              id: "search",
  ...
  var It = (function (t) {
          ...
          return y(
            ...
            this.props.data &&
              this.props.data.rows.map(function (e) {
                return y(At, { key: e.id, row: e, header: t.props.header });
              }),
    ...
    zt = (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (r.store = new Ht(r.config.dispatcher)),
          e.enabled &&
    ...
    qt = (function (t) {
      ...
      return (
        n(e, t),
        (e.prototype.getPageX = function (t) {
                ...
                r
                  ? (clearTimeout(o),
                    (o = setTimeout(function () {
                      Date.now() - i >= n &&
                        (e.apply(void 0, t), (i = Date.now()));
                    }, Math.max(n - (Date.now() - i), 0))))
                  : (e.apply(void 0, t), (i = Date.now()), (r = !0));
              })),
          ...
          return (
            ...
            y(
              ...
              this.isResizable() &&
                ...
                y(qt, { column: this.props.column, thRef: this.thRef })
            )
          );
        }),
        e
  ...
  var Xt,
      ...
      return (
        ...
        (e.prototype.renderColumn = function (t, e, n, r) {
          var o = (function (t, e, n) {
            ...
            i = o.rowSpan,
            s = o.colSpan;
          return y(Gt, { column: t, index: n, colSpan: s, rowSpan: i });
        }),
                ...
                case 1:
                  return (
                    ...
                    t.header &&
                      ...
                      this.setState({ header: t.header.adjustWidth(t) }),
            ...
            y(
              "div",
              {
                ...
                className: nt(
                  "gridjs",
                  et("container"),
                  this.state.status === wt.Loading ? et("loading") : null,
    ...
    te = (function (t) {
      function e(e) {
        var n = t.call(this) || this;
        return (
          (n.config = new Lt({ instance: n, eventEmitter: n }).update(e)),
  ...
  (a.__b = function (t) {
    ...
    (a.diffed = function (t) {
      ...
      e &&
        e.__H &&
        e.__H.__h.length &&
        ((1 !== ne.push(e) && Kt === a.requestAnimationFrame) ||
          (
            (Kt = a.requestAnimationFrame) ||
            function (t) {
              var e,
                n = function () {
  ...
  (t.BaseActions = st),
    ...
    (t.useEffect = function (t, e) {
      var n = ue(Xt++, 3);
      !a.__s && fe(n.__H, e) && ((n.__ = t), (n.__H = e), $t.__H.__h.push(n));
    }),
    (t.useRef = function (t) {
      return (
        (ee = 5),
